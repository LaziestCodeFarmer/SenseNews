...
import com.xtl.dao.typeNewsDao;
...
public class typeNewsService {
    @Autowired
    typeNewsDao typeNewsdao;

    public article[] searchNewsByType(String type,Integer n,Integer m) throws ParseException {
        article[] articles = typeNewsdao.searchNewsByType(type, n, m);
        //数据处理（跟首页的数据处理一样）
